        ...
        segment_rows.append(
            {
                ...
                "start_phase_fingerprint": digest_array(segment_start_phase),
                "terminal_phase_fingerprint": digest_array(result_phase),
    ...
    if stalled_terminal:
        ...
        for budget in missing:
            ...
            checkpoint_rows.append(dict(requested_budget=budget, accepted_iteration=int(accepted),
                ...
                phase_fingerprint=digest_array(terminal_phase)))
